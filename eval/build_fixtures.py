...
This script generates deterministic test PDFs used by:
  eval/examples/pdf_suite.example.json
"""
...
_FIXTURE_DIR = _PROJECT_ROOT / "eval" / "examples" / "fixtures" / "pdf_eval"
_SUITE_PATH = _PROJECT_ROOT / "eval" / "examples" / "pdf_suite.example.json"
