...
def run_suite(
    ...
    logger.info("Using RAG config: %s", json.dumps(dataclasses.asdict(cfg), ensure_ascii=False))
    ...
    for idx, case in enumerate(cases_raw, 1):
        ...
        top_k = int(case.get("top_k", cfg.top_k))
