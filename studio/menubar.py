...
def build_menubar(window: QMainWindow) -> None:
    ...
    window._add_action(file_menu, "Save Project Folder…", "Ctrl+Shift+S", window._save_project)
    window._add_action(file_menu, "Load Project Folder…", "Ctrl+Shift+O", window._load_project)
    window._add_action(file_menu, "Export Project (.d2c)…", "", window._export_project_archive)
    window._add_action(file_menu, "Import Project (.d2c)…", "", window._import_project_archive)
    file_menu.addSeparator()
