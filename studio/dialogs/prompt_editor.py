    ...
    def _setup_ui(self, *, prompt_values: dict[str, str] | None = None):
        ...
        prompt_specs = {
            ...
            "nli_verify_system": {
                ...
                "kind": "System",
                "desc": "Workflow-Beschreibung für NLI (Claim-vs-Chunk).",
            },
            "nli_verify_user": {
                "group": "Faktencheck",
            ...
            "hyde_tfidf_system": {
                "group": "RAG",
                "title": "HyDE Legacy Lexical: System",
                "kind": "System",
                "desc": "Legacy-Rolle für frühere lexikale Expansion (v2 kompatibilitätsgeführt).",
            },
            "hyde_tfidf_user": {
                "group": "RAG",
                "title": "HyDE Legacy Lexical: User",
                "kind": "User",
                "desc": "Legacy-Auftrag zur Generierung von Literal-Suchbegriffen (v2 kompatibilitätsgeführt).",
                "placeholders": "{query}",
            },
            "hyde_st_single_system": {
                "group": "RAG",
                "title": "HyDE Vector Single: System",
                "kind": "System",
                "desc": "Rolle für 1 hypothetischen Absatz (semantische Suche).",
            },
            "hyde_st_single_user": {
                "group": "RAG",
                "title": "HyDE Vector Single: User",
                "kind": "User",
            ...
            "hyde_st_multi_system": {
                "group": "RAG",
                "title": "HyDE Vector Multi: System",
                "kind": "System",
                "desc": "Rolle für mehrere hypothetische Absätze.",
            },
            "hyde_st_multi_user": {
                "group": "RAG",
                "title": "HyDE Vector Multi: User",
                "kind": "User",
