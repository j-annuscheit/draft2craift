...
class AgenticSettingsKeys:
    ...
    MINDMAP_FACTCHECK: Final[str] = "agentic/mindmap_factcheck"
    MINDMAP_MAX_NODES: Final[str] = "agentic/mindmap_max_nodes"
    MINDMAP_MAX_REFINEMENT_ROUNDS: Final[str] = "agentic/mindmap_max_refinement_rounds"
    MINDMAP_RETRIEVAL_STRATEGY: Final[str] = "agentic/mindmap_retrieval_strategy"
    MINDMAP_AGENT_MAX_ITERATIONS: Final[str] = "agentic/mindmap_agent_max_iterations"
    MINDMAP_CONTEXT_MAX_CHARS: Final[str] = "agentic/mindmap_context_max_chars"
    MINDMAP_USE_FULL_CONTEXT: Final[str] = "agentic/mindmap_use_full_context"
    MINDMAP_AGENT_ALLOW_RAG: Final[str] = "agentic/mindmap_agent_allow_rag"
    MINDMAP_AGENT_ALLOW_REGEX: Final[str] = "agentic/mindmap_agent_allow_regex"
    MINDMAP_AGENT_ALLOW_HEADING: Final[str] = "agentic/mindmap_agent_allow_heading"
    MINDMAP_AGENT_ALLOW_FULL_TEXT: Final[str] = "agentic/mindmap_agent_allow_full_text"
    MINDMAP_AGENT_ALLOW_QUERY_NARROWING: Final[str] = "agentic/mindmap_agent_allow_query_narrowing"
    MINDMAP_AGENT_ALLOW_HEADING_SUMMARIES: Final[str] = "agentic/mindmap_agent_allow_heading_summaries"
    MINDMAP_AGENT_MAX_REGEX_CALLS: Final[str] = "agentic/mindmap_agent_max_regex_calls"
    GRAPH_FACTCHECK: Final[str] = "agentic/graph_factcheck"
    GRAPH_MAX_NODES: Final[str] = "agentic/graph_max_nodes"
    GRAPH_RETRIEVAL_STRATEGY: Final[str] = "agentic/graph_retrieval_strategy"
    GRAPH_AGENT_MAX_ITERATIONS: Final[str] = "agentic/graph_agent_max_iterations"
    GRAPH_CONTEXT_MAX_CHARS: Final[str] = "agentic/graph_context_max_chars"
    GRAPH_USE_FULL_CONTEXT: Final[str] = "agentic/graph_use_full_context"
    GRAPH_AGENT_ALLOW_RAG: Final[str] = "agentic/graph_agent_allow_rag"
    GRAPH_AGENT_ALLOW_REGEX: Final[str] = "agentic/graph_agent_allow_regex"
    GRAPH_AGENT_ALLOW_HEADING: Final[str] = "agentic/graph_agent_allow_heading"
    GRAPH_AGENT_ALLOW_FULL_TEXT: Final[str] = "agentic/graph_agent_allow_full_text"
    GRAPH_AGENT_ALLOW_QUERY_NARROWING: Final[str] = "agentic/graph_agent_allow_query_narrowing"
    GRAPH_AGENT_ALLOW_HEADING_SUMMARIES: Final[str] = "agentic/graph_agent_allow_heading_summaries"
    GRAPH_AGENT_MAX_REGEX_CALLS: Final[str] = "agentic/graph_agent_max_regex_calls"
