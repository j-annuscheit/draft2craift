...
- Das Starten ueber `start_portable.bat` sorgt fuer konsistente relative Pfade fuer Modelle und Caches.
...
- Autosave liegt im benutzerspezifischen AppData-Bereich (`QStandardPaths/AppDataLocation`),
  nicht im portablen Ordner
